...
* CD into your new package dir and run `$ php prefill.php` in the command line. Follow the prompts to replace Shawn Sandy shawnsandy http://shawnsandy.com shawnsandy04@gmail.com shawsandy tokker OpenTok package for Laravel :psr4_namespace with their correct values package files, CHANGELOG.md, CONTRIBUTING.md, LICENSE.md, `/src/**.php` and composer.json files:  Delete the file prefill.php when done.
